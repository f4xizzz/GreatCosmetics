...
public class EffectConfig {
    ...
    private static void generateDefaults() {
        ...
        // Exemplos "clássicos" (nuvem de partículas SIMPLE) — nomes profissionais.
        ...
        effectsMap.put("radiant_aura", e2);
        ...
        effectsMap.put("smoke_wisp", e3);

        // Um efeito PRONTO por preset de forma (ver EffectPresets) — o admin já abre o mod com
        // exemplos de anel/hélice/feixe/pulso pra editar em cima, não só nuvens SIMPLE.
        for (String presetName : EffectPresets.names()) {
            EffectData e = EffectPresets.instantiate(presetName);
            if (e == null) continue;
            String id = presetName.toLowerCase()
                    .replaceAll("[^a-z0-9]+", "_")
                    .replaceAll("^_+|_+$", "");
            effectsMap.put(id, e);
        }
