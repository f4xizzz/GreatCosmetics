...
public record SyncPlayerCosmeticsPayload(
    ...
    public static final CustomPayload.Id<SyncPlayerCosmeticsPayload> ID = new CustomPayload.Id<>(Identifier.of("greatcosmetics", "sync_player_cosmetics"));

    public static final PacketCodec<RegistryByteBuf, SyncPlayerCosmeticsPayload> CODEC = PacketCodec.of(
