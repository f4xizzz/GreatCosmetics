...
public class GreatCosmeticsGeoItem extends Item implements GeoItem {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("sascosmetics", "geo_display");

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public GreatCosmeticsGeoItem(Properties settings) {
        super(settings);
    }
