...
public class GreatCosmeticsGeoModel extends GeoModel<GreatCosmeticsGeoItem> {
    ...
    private static final ResourceLocation FALLBACK_MODEL = ResourceLocation.fromNamespaceAndPath("sascosmetics", "geo/item/fallback.geo.json");
    private static final ResourceLocation FALLBACK_TEXTURE = ResourceLocation.fromNamespaceAndPath("sascosmetics", "textures/item/fallback.png");
    private static final ResourceLocation FALLBACK_ANIMATION = ResourceLocation.fromNamespaceAndPath("sascosmetics", "animations/item/fallback.animation.json");

    @Override
    public ResourceLocation getModelResource(GreatCosmeticsGeoItem animatable, GeoRenderer<GreatCosmeticsGeoItem> renderer) {
        GeoModelRegistry.Entry entry = resolveEntry(renderer);
        return entry != null ? entry.geoModel() : FALLBACK_MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(GreatCosmeticsGeoItem animatable, GeoRenderer<GreatCosmeticsGeoItem> renderer) {
        GeoModelRegistry.Entry entry = resolveEntry(renderer);
        return entry != null ? entry.texture() : FALLBACK_TEXTURE;
    }

    @Override
    public ResourceLocation getModelResource(GreatCosmeticsGeoItem animatable) {
        return FALLBACK_MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(GreatCosmeticsGeoItem animatable) {
        return FALLBACK_TEXTURE;
    }

    @Override
    public ResourceLocation getAnimationResource(GreatCosmeticsGeoItem animatable) {
