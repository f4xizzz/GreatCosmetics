...
public class LangConfig {
    ...
    private static final File LANG_DIR = new File(Platform.getConfigFolder().toFile(), "GreatCosmetics/lang");
    private static final File LEGACY_FILE = new File(Platform.getConfigFolder().toFile(), "GreatCosmetics/lang.json");
    ...
    /** {@link Component} pra tooltip/placeholder de GUI — resolvido via legado {@code §}, sem registries. */
    public static MutableComponent text(String key, Object... ph) {
        return Component.literal(legacy(key, ph));
    }

    /** {@link Component} rico (com {@code <hover>}/{@code <click>} de verdade) pro chat — precisa de registries. */
    public static Component chat(String key, HolderLookup.Provider registries, Object... ph) {
