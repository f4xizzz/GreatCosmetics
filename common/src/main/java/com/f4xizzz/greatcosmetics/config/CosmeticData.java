...
public class CosmeticData {
    ...
    public net.minecraft.network.chat.Component getFormattedNameText(net.minecraft.core.HolderLookup.Provider registries) {
    ...
    public java.util.List<net.minecraft.network.chat.Component> getFormattedNameLines(net.minecraft.core.HolderLookup.Provider registries) {
        ...
        java.util.List<net.minecraft.network.chat.Component> lines = new java.util.ArrayList<>(parts.length);
