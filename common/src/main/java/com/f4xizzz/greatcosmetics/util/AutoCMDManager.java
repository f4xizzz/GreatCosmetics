...
public class AutoCMDManager {
    ...
    public static void clear() {
        com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("AutoCMDManager.clear(): resetting counter (had " + registeredModels.size() + " models + " + registeredIcons.size() + " icons registered).");
