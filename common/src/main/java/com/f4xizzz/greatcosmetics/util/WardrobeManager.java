...
public class WardrobeManager {
    ...
    public static void loadStudios() {
        ...
        try (FileReader reader = new FileReader(SAVE_FILE)) {
            ...
            if (loaded != null) {
                ...
                com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("Loaded " + studioLocations.size() + " saved Wardrobe studios!");
            }
        } catch (Exception e) {
    ...
    public static void forceReturnIfPending(ServerPlayer player) {
        ...
        if (world != null) {
            ...
            com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("Player " + player.getName().getString() + " was stuck in the wardrobe/studio — automatically returned.");
        }
        saveSessions();
    }
    ...
    public static void openWardrobe(ServerPlayer target, String bgName) {
        ...
        if (com.f4xizzz.greatcosmetics.GcServer.licenseBlocked(target)) return;
        ...
        boolean isOp = com.f4xizzz.greatcosmetics.GcServer.isRealOperator(target);
        ...
        com.f4xizzz.greatcosmetics.platform.GcNet.toPlayer(target, new com.f4xizzz.greatcosmetics.network.SyncDevPermissionsPayload(
                isOp,
                com.f4xizzz.greatcosmetics.GcServer.checkPermission(target, "gc.dev"),
                com.f4xizzz.greatcosmetics.GcServer.checkPermission(target, com.f4xizzz.greatcosmetics.config.MainConfig.config.devModePermission)
        ));
        ...
        com.f4xizzz.greatcosmetics.platform.GcNet.toPlayer(target, new com.f4xizzz.greatcosmetics.network.SyncNameTagPayload(prefixSuffix[0], prefixSuffix[1]));
        ...
        com.f4xizzz.greatcosmetics.platform.GcNet.toPlayer(target, new OpenWardrobePayload(hasSavedBackground, isOp, unlockedCosmetics));
    }
    ...
    public static void closeWardrobeAndReturn(ServerPlayer player) {
        ...
        if (oldLoc != null) {
            ...
            com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("Player " + player.getName().getString() + " returned.");
        }
    }
}