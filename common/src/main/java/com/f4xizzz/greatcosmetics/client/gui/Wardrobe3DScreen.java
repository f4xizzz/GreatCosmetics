...
public class Wardrobe3DScreen extends Screen {
    ...
    protected void init() {
        if (this.minecraft != null && this.minecraft.player != null) {
            if (!this.isInitialized) {
                com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("Wardrobe3DScreen: opening for " + this.minecraft.player.getName().getString() + ".");
    ...
    public void removed() {
        super.removed();
        com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("Wardrobe3DScreen: closing.");
        ...
        if (!com.f4xizzz.greatcosmetics.client.gui.pages.PartyPage.waitingForPcToOpen) {
            com.f4xizzz.greatcosmetics.platform.GcNet.toServer(new CloseWardrobePayload());
        }
    }
