...
public class DevTypesSubPage extends DevSubPage {
    ...
    public void render(GuiGraphics c, int mouseX, int mouseY, float delta, int x, int y, int width, int height) {
        ...
        if (currentState == State.LIST) {
            ...
            c.drawCenteredString(parent.getTextRenderer(), L("devstudio.type.list_title"), x + (width / 2) + 8, topY + 2, 0xFFFFFF);
            ...
            c.drawCenteredString(parent.getTextRenderer(), L("devstudio.type.new"), x + (width/2), topY + 19, 0xFFFFFF);
            ...
            for (int i = 0; i < ids.size(); i++) {
                ...
                int nameW = parent.getTextRenderer().width(typeId);
                int maxW = width - 40;
                int textY = itemY + 6;
                ...
                if (nameW > maxW) {
                    ...
                    c.drawString(parent.getTextRenderer(), typeId, x + 18 - offset, textY, 0xFFFFFF);
                    RenderSystem.disableScissor();

                    parent.enablePerfectScissor(c, x, listY, width, height - (topY - y + 40));
                } else {
                    c.drawString(parent.getTextRenderer(), typeId, x + 18, textY, 0xFFFFFF);
                }
            }
            RenderSystem.disableScissor();
