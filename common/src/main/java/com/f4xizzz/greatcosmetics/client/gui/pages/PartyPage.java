...
public class PartyPage extends WardrobePage {
    ...
    private void rebuildPreviewEntity() {
        ...
        try {
            ...
            com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("PartyPage.rebuildPreviewEntity FAILED for skin '"
                    + (previewingSkin != null ? previewingSkin.getId() : "?") + "': " + e);
            if (com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugMode) e.printStackTrace();
        }
    }
    ...
    private void updateAvailableSkins() {
        ...
        for (PokemonSkin skin : SkinConfigManager.getAllSkins()) {
            ...
            try {
                ...
                com.f4xizzz.greatcosmetics.GreatCosmeticsCommon.debugLog("PartyPage skin icon FAILED for '" + skin.getId()
