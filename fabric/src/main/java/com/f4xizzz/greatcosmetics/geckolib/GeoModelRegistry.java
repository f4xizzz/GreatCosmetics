...
public class GeoModelRegistry {
    ...
    public record Entry(ResourceLocation geoModel, ResourceLocation texture, ResourceLocation animation) {}
    ...
    public static void register(int key, ResourceLocation geoModel, ResourceLocation texture, ResourceLocation animation) {
        if (key == 0) return;
